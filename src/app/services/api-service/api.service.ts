...
import { PROTOTYPE_SCHEDULE_URL, TEST_URL } from 'src/app/constants/api-constants';
...
export class APIService {
  ...
  getPrototypeSchedule():Observable<EmployeeSchedule> {
    ...
    return this.httpClient.get<EmployeeSchedule>(PROTOTYPE_SCHEDULE_URL, {params:queryParams})
  }
}
