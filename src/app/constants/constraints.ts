...
import { BooleanConstraint } from "../models/BooleanConstraint";
...
DISPLAY_NAME_CONSTRAINT_MAP.set(IDENTICAL_WEEKEND_DISPLAY_NAME, new BooleanConstraint(IDENTICAL_WEEKEND_ID, IDENTICAL_WEEKEND_DISPLAY_NAME));
DISPLAY_NAME_CONSTRAINT_MAP.set(COMPLETE_WEEKEND_DISPLAY_NAME, new BooleanConstraint(COMPLETE_WEEKEND_ID, COMPLETE_WEEKEND_DISPLAY_NAME));
