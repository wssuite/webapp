...
export const MAIN_MENU_BUTTONS: MainMenuButton[] = [
    {
        title: "Schedule",
        description: "View the previously generated schedule or generate a new schedule.",
        icon: ASSETS_FOLDER_LOCATION + "/calendar.png"
    },
    {
        title: "Contracts",
        description: "View and modify the  available contracts or create a new contract.",
