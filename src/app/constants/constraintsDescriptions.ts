...
export const TOTAL_WEEKENDS_IN_FOUR_WEEKS_DESCRIPTION = "Declare the minimum and maximum number of weekends that can be assigned to a nurse within four weeks.";
export const ALTERNATIVE_SHIFT_DESCRIPTION="Declare all shifts that you might want to see less frequently withn the planing horizon.";
...
export const IDENTICAL_WEEKEND_DESCRIPTION = "Impose identical shifts for all weekends within your working horizon.";
export const COMPLETE_WEEKEND_DESCRIPTION = "Impose that a nurse has to work the whole weekend.";
export const MIN_MAX_NUM_ASSIGNMENTS_IN_FOUR_WEEKS_DESCRIPTION = "Declare the minimum and maximum number of assignments a nurse can work within four weeks.";
...
export const UNWANTED_SKILLS_DESCRIPTION="Declare all skills that you might want to see less frequently withn the planing horizon.";
