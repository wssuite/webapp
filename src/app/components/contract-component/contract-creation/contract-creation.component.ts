  ...
  addConstraint(name: string) {
    ...
    switch(name) {
      case UNWANTED_PATTERNS_DISPLAY_NAME:
        constraint = new UnwantedPatterns(UNWANTED_PATTERNS_ID, UNWANTED_PATTERNS_DISPLAY_NAME, UNWANTED_PATTERNS_DESCRIPTION); 
        break;

      case ALTERNATIVE_SHIFT_DISPLAY_NAME:
        constraint = new AlternativeShift(ALTERNATIVE_SHIFT_ID, ALTERNATIVE_SHIFT_DISPLAY_NAME, ALTERNATIVE_SHIFT_DESCRIPTION);
        break;

      case FREE_DAYS_AFTER_SHIFT_DISPLAY_NAME:
        constraint = new ShiftConstraint(FREE_DAYS_AFTER_SHIFT_ID, FREE_DAYS_AFTER_SHIFT_DISPLAY_NAME, FREE_DAYS_AFTER_SHIFT_DESCRIPTION);
        break;

      case MIN_MAX_CONSECUTIVE_SHIFT_TYPE_DISPLAY_NAME:
        constraint = new MinMaxShiftConstraint(MIN_MAX_CONSECUTIVE_SHIFT_TYPE_ID, MIN_MAX_CONSECUTIVE_SHIFT_TYPE_DISPLAY_NAME, MIN_MAX_CONSECUTIVE_SHIFT_TYPE_DESCRIPTION);
        break;

      case IDENTICAL_WEEKEND_DISPLAY_NAME:
        constraint = new BooleanConstraint(IDENTICAL_WEEKEND_ID, IDENTICAL_WEEKEND_DISPLAY_NAME, IDENTICAL_WEEKEND_DESCRIPTION);
        break;

      case COMPLETE_WEEKEND_DISPLAY_NAME:
        constraint = new BooleanConstraint(COMPLETE_WEEKEND_ID, COMPLETE_WEEKEND_DISPLAY_NAME, COMPLETE_WEEKEND_DESCRIPTION);
        break;
      ...
      case UNWANTED_SKILLS_DISPLAY_NAME:
        constraint = new UnwantedSkills(UNWANTED_SKILLS_ID, UNWANTED_SKILLS_DISPLAY_NAME, UNWANTED_SKILLS_DESCRIPTION);
      break;
